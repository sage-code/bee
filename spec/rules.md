...
Bee is a rule oriented language. We use rules to create small sub-programs that serve diverse roles. This chapter describe how to design and use the rules.
...
**Notes:** Usually the attributes have default values; 
